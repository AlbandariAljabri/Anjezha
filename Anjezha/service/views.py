...
def display_task_view(request: HttpRequest ):
    ...
    return render(request, "service/display_task.html", {"tasks": tasks , "supervisors" : supervisors , "is_worker":is_worker ,"is_supervisor" :is_supervisor})
